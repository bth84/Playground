...
drivers = spark.read.csv("./Tools/Spark/duocar/raw/drivers/", header=True, inferSchema=True)
riders = spark.read.csv("./Tools/Spark/duocar/raw/riders/", header=True, inferSchema=True)
