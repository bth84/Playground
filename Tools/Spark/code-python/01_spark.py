...
rides = spark.read.csv("./Tools/Spark/duocar/raw/rides/", sep=",", header=True, inferSchema=True)

# **Note:** HDFS is the default file system.
...
# Spark](https://www.cloudera.com/documentation/data-science-workbench/latest/topics/cdsw_dist_comp_with_Spark.html)
