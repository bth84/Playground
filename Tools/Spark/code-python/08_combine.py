...
spark = SparkSession.builder.master("local").appName("combine").getOrCreate()
...
scientists = spark.read.csv("./Tools/Spark/duocar/raw/data_scientists/", header=True, inferSchema=True)
scientists.show()

offices = spark.read.csv("./Tools/Spark/duocar/raw/offices/", header=True, inferSchema=True)
offices.show()
...
rides = spark.read.parquet("./Tools/Spark/duocar/clean/rides/")
drivers = spark.read.parquet("./Tools/Spark/duocar/clean/drivers/")
riders = spark.read.parquet("./Tools/Spark/duocar/clean/riders/")
reviews = spark.read.parquet("./Tools/Spark/duocar/clean/ride_reviews/")
...
# repository:
spark.read.parquet("./Tools/Spark/duocar/joined/").printSchema()
