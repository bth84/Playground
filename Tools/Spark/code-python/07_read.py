...
riders = spark \
  .read \
  .csv("./Tools/Spark/duocar/raw/riders/", sep=",", header=True, inferSchema=True) \
...
riders = spark \
  ...
  .load("./Tools/Spark/duocar/raw/riders/")
...
weblogs = spark.read.text("./Tools/Spark/duocar/earcloud/apache_logs/")
weblogs.printSchema()
weblogs.head(5)
...
# file:
riders2.write.parquet("./Tools/Spark/data/riders_parquet/")
...
# Parquet file:
spark.read.parquet("./Tools/Spark/data/riders_parquet/").printSchema()
